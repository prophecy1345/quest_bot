...
# Настройки бота
TOKEN = "8151132346:AAEPhnomb16R89Qx9pdZWADDNSTuXnstvSc"  # Вставь сюда свой токен из BotFather
...
async def process_question10(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        ...
        "\n"
        "А ещё у меня есть маленький сюрприз для тех, кто дошёл до конца. 🎁\n"
        "\n"
